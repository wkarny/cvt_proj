...
The [examples](https://github.com/grpc/grpc-java/tree/v1.18.0/examples) and the
[Android example](https://github.com/grpc/grpc-java/tree/v1.18.0/examples/android)
