...
public class HelloWorldServer {
  ...
  static class GreeterImpl extends HelloWorld.HelloWorldImplBase {

    @Override
    public void greet(HelloRequest.Reader req, StreamObserver<HelloResponce.Reader> responseObserver) {
